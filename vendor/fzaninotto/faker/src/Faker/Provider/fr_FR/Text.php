...
était à Paris, maintenant; là-bas! DxComment était ce Paris? Quel
...
penchant sur son assiette, c'est modestie pure. -- DxComment, mon
...
avec une dame. DxComment donc avoir pu lui exposer, et en un tel
...
-- DxComment vous portez-vous? ajouta-t-il.
...
-- DxComment! qu'importe? Il me semble, à moi, que lorsqu'on est
...
seul espoir possible d'une félicité! DxComment n'avait-elle pas
...
-- DxComment! vous ne savez pas cela? On va le saisir cette semaine.
...
-- DxComment, monsieur Boulanger, vous nous abandonnez?
...
-- Te voilà! te voilà! répétait-il. DxComment as-tu fait pour
...
-- DxComment va votre jeune personne? demanda tout à coup madame
Homais.
...
-- DxComment vas-tu? disaient-ils en lui frappant sur l'épaule. Ah!
...
DxComment donc avait-elle fait (elle qui était si intelligente!)
...
-- DxComment vais-je signer, maintenant? se dit-il. Votre tout
...
-- Ah! bonjour... DxComment! vous voilà?
...
toutes les façons. DxComment se débarrasser de lui? Quelle
...
-- DxComment diable est-ce dans mes bottes?
...
-- DxComment! comment! balbutia-t-elle.
...
voilà! en voilà, des ajustements! des flaflas! DxComment! de la soie
...
-- DxComment voulais-tu que je vécusse sans toi? On ne peut pas se
...
-- DxComment s'est-elle donc empoisonnée?
...
-- DxComment! fit l'ecclésiastique, la prière! Vous n'êtes donc pas
chrétien?
